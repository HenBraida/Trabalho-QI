							...
							if(isset($_SESSION['cliente'])){
								...
								foreach($_SESSION['cliente'] as $i=>$cliente){
									...
									or str_contains($cpf,$_GET['nome']))									
										...
										<td>
											<div class='row'>
												...
												<form action='cadCliente.php' method='GET' style='display:inline;'>
													...
													<input type='hidden' name='cnh' value='$idade'>  	        
													<button type='submit' class='btn-danger' name='delCliente'>
														<i class='fa fa-trash'></i>
													</button>
																						
													<button type='submit' class='btn-info' name='ediCliente'>
										...
										<td>$nome</td><td>$cpf</td><td>$idade</td></tr>";  
									} 
								}    
